...
import FRC867.Nano2014.subsystems.LaserPointer;
...
public abstract class CommandBase extends Command {
    ...
    public static LaserPointer laserPointer = new LaserPointer();
    ...
    public static void init() {
        ...
        //Starts the aiming laser
        Command turnOnLaser = new TurnOnLaser();
        turnOnLaser.start();
